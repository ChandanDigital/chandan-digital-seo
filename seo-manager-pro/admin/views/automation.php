...
<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>"><input type="hidden" name="action" value="seom_save_advanced"><?php wp_nonce_field('seom_save_advanced'); ?>
